...
//-----------------------------------------------------------------------------
//----- IPieSectorExploded.h : Declaration of the CPieSectorExploded
//-----------------------------------------------------------------------------
#pragma once
...
//-----------------------------------------------------------------------------
//----- CPieSectorExploded
class ATL_NO_VTABLE CPieSectorExploded : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CPieSectorExploded, &CLSID_PieSectorExploded>,
	public ISupportErrorInfo,
	public IDispatchImpl<IPieSectorExploded, &IID_IPieSectorExploded, &LIBID_AsdkDeepPropInspectorUILib, 1, 0>,
    public DynPropBaseImpl<CPieSectorExploded>
{
protected:
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_PIESECTOREXPLODED)
	DECLARE_PROTECT_FINAL_CONSTRUCT()

	BEGIN_COM_MAP(CPieSectorExploded)
		COM_INTERFACE_ENTRY(IPieSectorExploded)
...
//-----------------------------------------------------------------------------
OBJECT_ENTRY_AUTO(__uuidof(PieSectorExploded), CPieSectorExploded)
//- See DynPropOrder.h for details
//OPM_DYNPROP_OBJECT_ENTRY_AUTO(CPieSectorExploded, AsdkPie)
