...
>
class ATL_NO_VTABLE IAcadPointImpl : 
	public IAcadEntityBaseDispatchImpl<T, rxClass, interfaceClass, IAcadPoint, pclsid, &CLSID_AcadPoint, piid, plibid>
{
public:
	//- IAcadPoint
	...
	STDMETHOD(put_Coordinates) (VARIANT Coordinates ) {
		return (mpInnerObject->put_Coordinates (Coordinates)) ;
	}
